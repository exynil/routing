...
function calculation() {
	switch(input_02) {
		case '0': netmask = [ 0, 0, 0, 0 ]; break;
		case '1': netmask = [ 128, 0, 0, 0 ]; break;
		case '2': netmask = [ 192, 0, 0, 0 ]; break;
		case '3': netmask = [ 224, 0, 0, 0 ]; break;
		case '4': netmask = [ 240, 0, 0, 0 ]; break;
		case '5': netmask = [ 248, 0, 0, 0 ]; break;
		case '6': netmask = [ 252, 0, 0, 0 ]; break;
		case '7': netmask = [ 254, 0, 0, 0 ]; break;
		case '8': netmask = [ 255, 0, 0, 0 ]; break;
		case '9': netmask = [ 255, 128, 0, 0 ]; break;
		case '10': netmask = [ 255, 192, 0, 0 ]; break;
		case '11': netmask = [ 255, 224, 0, 0 ]; break;
		case '12': netmask = [ 255, 240, 0, 0 ]; break;
		case '13': netmask = [ 255, 248, 0, 0 ]; break;
		case '14': netmask = [ 255, 252, 0, 0 ]; break;
		case '15': netmask = [ 255, 254, 0, 0 ]; break;
		...
		case '32': netmask = [ 255, 255, 255, 255 ]; break;
	}
	sum = 0;
	octet = -1;
	cycle_stop = false;
	...
	for (var i = 0; i <= 3; i++) {
		for (var k = 0; k <= 3; k++) {
			...
			num_backup = 0;
			switch (i) {
			case 0: num = ip_bin[k]; break;
			case 1: num = netmask_bin[k]; break;
			case 2: num = network_bin[k]; break;
			case 3: num = broadcast_bin[k]; break;
			}
			while (count != 0) {
			...
			switch (i) {
			case 0: ip_dec[k] = num_backup; break;
			case 1: netmask_dec[k] = num_backup; break;
			case 2: network_dec[k] = num_backup; break;
			case 3: broadcast_dec[k] = num_backup; break;
			}
		}
	}
	for (var i = 0; i <= 2; i++) {
